...
# ---------------- CONFIG (fill these) ----------------
GUILD_ID = 1501126256849322135  # your guild/server ID

# channels
# channels
TRANSACTIONS_ID = 1501126261706199109
MATCH_TIMES_CHANNEL_ID = 1501126261706199107
ASSIGNMENTS_CHANNEL_ID = 1501126262570090589
SCRIM_CATEGORY_ID = 1501129976605311016  # put your Scheduling category ID here, or 0 to create/use none
MATCH_SCORES_CHANNEL_ID = 1501126261706199105  # put your match-score channel ID here

# staff/team roles
CAPTAIN_ROLE_ID = 1501130096856006656
CO_CAPTAIN_ROLE_ID = 1501130531948199986
EXECUTIVE_ROLE_ID = 1504947375456653486
TEAM_PLAYER_ROLE_ID = 1504947469086228611

# assignment roles
HEAD_REF_ROLE_ID = 1504957886621552750
REF_ROLE_ID = 1501126256916303962
HEAD_CASTER_ROLE_ID = 1504957916669673673
CASTER_ROLE_ID = 1501126256916303961

FAQ_CHANNEL_ID = 1504956158308388915  # replace with the channel ID where FAQ should be posted
STREAM_WATCHER_ROLE_ID = 1504956596411957258  # 🎥 Stream Watcher
UNBORN_CAPTAIN_ROLE_ID = 1501126256907780210  # 🚀 Unborn Captain
EVENT_PING_ROLE_ID = 1504956654125322260      # 🎉 Event Ping
...
async def faq(interaction: discord.Interaction):
    ...
    text = (
        ...
        "> - We will use <#1501126261139832882> to update you on our team situation! We pick the best teams we can from out forms, so make sure you are active and competitive!\n"
